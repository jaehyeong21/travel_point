...
export default function Logo() {
  return (
    <div className="items-center relative flex">
      <Link data-test="logo" className="text-blue-800/90 md:pr-12 flex" href="/">
        <span className="sr-only">Home with logo image</span>
        <img width={36} height={36} src={'/assets/favicons/logoImage.webp'} alt='logo image' className='absolute mr-2 -top-1.5 -left-3'/>
